...
class CelebornServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceComponentLayoutValidations(self, services, hosts):
    ...
    return self.getServiceComponentCardinalityValidations(services, hosts, "CELEBORN")
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendCelebornConfigurationsFromHDP33(configurations, clusterData, services, hosts)
...
class CelebornRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendCelebornConfigurationsFromHDP33(self, configurations, clusterData, services, hosts):
    """
