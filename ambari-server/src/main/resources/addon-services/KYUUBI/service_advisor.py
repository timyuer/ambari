...
class KyuubiServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendKyuubiConfigurationsFromHDP33(configurations, clusterData, services, hosts)
...
class KyuubiRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendKyuubiConfigurationsFromHDP33(self, configurations, clusterData, services, hosts):
    """
    Recommend configurations for this service based on HDP 3.3.
    """

    putKyuubiDefaultsProperty = self.putProperty(configurations, "kyuubi-defaults", services)
    putKyuubiDefaultsPropertyAttribute = self.putPropertyAttribute(configurations, "kyuubi-defaults")   

    zookeeper_host_port = self.getZKHostPortString(services)
    putKyuubiDefaultsProperty("kyuubi.ha.zookeeper.quorum", zookeeper_host_port)
    putKyuubiDefaultsProperty("kyuubi.ha.addresses", zookeeper_host_port)
    putKyuubiDefaultsProperty("kyuubi.ha.client.class", 'org.apache.kyuubi.ha.client.zookeeper.ZookeeperDiscoveryClient')
